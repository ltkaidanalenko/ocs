...
const characters = {
  ...
  viorel_dmitrescu: {
   ...
   ac1: '#7d4f6e',
   ac2: '#603954',
   image:'/ocs/images/viorel-image.png',
   header:'/ocs/images/viorel-header.png',
   icon1:'/ocs/images/viorel-icon1.png',
   icon2:'/ocs/images/viorel-icon2.png',
   side:'/ocs/images/viorel-side.png',
   info:'Lorem ipsum dolor sit amet.',
   history:'Lorem ipsum dolor sit amet.',
   misc:'Lorem ipsum dolor sit amet.',
   extra:'Lorem ipsum dolor sit amet.'
